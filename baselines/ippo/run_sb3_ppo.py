...
from algorithms.sb3.wandb_wrapper import WandbLogger, NoLogger
...
def train(exp_config: ExperimentConfig):
    ...
    checkpointer = ModelCheckpointer(logger, config) if exp_config.save_policy else NoCheckpointer(logger, config)
