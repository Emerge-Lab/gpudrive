...
class BaseAlgorithm(ABC):
    ...
    def _setup_learn(
        ...
        if reset_num_timesteps or self._last_obs is None:
            ...
            self._last_valids = th.ones((self.env.num_envs,), dtype=th.bool, device=self._last_obs.device)
            # pytype: enable=annotation-type-mismatch
            self._last_episode_starts = th.ones((self.env.num_envs,), dtype=bool, device=self._last_obs.device)
