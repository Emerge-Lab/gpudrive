...
from adaptive_driving_agent.ada.utils.checkpoint import load_policy
...
def setup_environment(config_path, model_path, data_path, num_envs=4, device="cpu", max_agents=64):
    """
...
def main():
    ...
    config_path = "/home/emerge/gpudrive/baselines/ppo/config/ppo_base_puffer"
    model_path = "/home/emerge/gpudrive/examples/experimental/models"
    data_path = "/home/emerge/gpudrive/data/processed/examples/"
