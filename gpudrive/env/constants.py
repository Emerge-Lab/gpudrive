...
MIN_RG_COORD = -1000
MAX_RG_COORD = 1000
MAX_ROAD_LINE_SEGMENT_LEN = 200
MAX_ROAD_SCALE = 100

# Feature shape constants
EGO_FEAT_DIM = 8  # Ego state base fields
PARTNER_FEAT_DIM = 6
ROAD_GRAPH_FEAT_DIM = 13

ROAD_GRAPH_TOP_K = madrona_gpudrive.kMaxAgentMapObservationsCount

# Dataset constants
LOG_TRAJECTORY_LENGTH = 91
...
# Action values
MAX_ACTION_VALUE = 15.0

MAX_LONGITUDINAL_JERK = 15.0
MAX_LATERAL_JERK = 4.0
