...
class MultiAgentCallback(BaseCallback):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.wandb_logger.define_metric("metrics/mean_ep_reward_per_agent", lambda: self.mean_reward_per_episode.value() / self.num_agent_rollouts.value())
        
        self.perc_goal_achieved = WindowedCounter(self.config.logging_collection_window)
        self.wandb_logger.define_metric("metrics/perc_goal_achieved",
        ...
        self.wandb_logger.define_metric("metrics/perc_off_road",
        ...
        self.wandb_logger.define_metric("metrics/perc_veh_collisions",
        ...
        self.wandb_logger.define_metric("metrics/perc_non_veh_collision",
        ...
        self.wandb_logger.define_metric("charts/obs_min", lambda: self.max_obs.value())
        ...
        self.wandb_logger.define_metric("charts/obs_min", lambda: self.min_obs.value())
    ...
    def _on_step(self) -> bool:
        ...
        if self.locals["env"].log_agg_world_info:
            ...
            self.wandb_logger.log_histograms_once({"charts/goal_achieved_dist": goal_achieved_dist,
    ...
    def _create_and_log_video(
        ...
        self.wandb_logger.log_video(self.num_timesteps, frames=np.moveaxis(frames, -1, 1), fps=15, format="gif",  caption=caption)
