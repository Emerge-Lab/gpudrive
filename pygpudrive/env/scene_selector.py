...
def select_scenes(config):
    """Selects scenes from a dataset based on the selection discipline.

    Args:
        config (dataclass): Configuration for selecting scenes.

    Returns:
        list: List of paths to the selected scenes.
    """
