...
NB_MODULE(gpu_hideseek_python, m) {
    ...
    nb::class_<Manager> (m, "HideAndSeekSimulator")
        .def("__init__", [](Manager *self, Manager::ExecMode exec_mode,
                            int64_t gpu_id, int64_t num_worlds,
                            int64_t render_width, int64_t render_height) {
           ...
           nb::arg("render_width"), nb::arg("render_height"))
